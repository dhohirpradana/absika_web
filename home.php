...
require_once('session/cek_sesi_admin.php');
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            <li class="nav-divider">
                                <a class="nav-link" href="?page=dashboard"><i class="fas fa-home"></i>Home</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="?page=guru"><i class="fa fa-fw fa-user-circle"></i>Profil Guru</a>
                            </li>
                            <li class="nav-item">
